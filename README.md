...
With the huge use and promising potential of Next.js I have decided to dive deeply and build a simple application as well as learn how to work with Google Auth specifically
...
```bash
git clone https://github.com/mlasitsa/share_prompts.git
cd share_prompts
```
